...
module.exports = {
    login: function (req, res) {
        ...
        User.findOne(find_data, conditions, function (err, data) {
            ...
            if ( ! data ) {
                res.status(500).send({
                    msg: 'Error! User with this email and password is not found!'
                });
            } else {
    ...
    signUpValidation: function (req, res, next) {
        ...
        User.findOne(find_data, function (err, data) {
            ...
            if ( data ) {
                res.status(500).send({
                    msg: 'User with this email has already existed'
                });
            }  else {
                next();
            }
    ...
    getCurrentUser: function (req, res) {
        ...
        var populate_data = 'friends subscriptions followers';
        var populate_fields = 'first_name last_name email';
